		...
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="information">
					<td colspan="4">
						<table>
							<tr>
								<td>
									{{App\Models\BillingDetails::where('order_id', $order_id)->first()->address}}<br />
								</td>
				...
				<tr class="total">
					...
					<td></td>
					<td></td>
					<td>Sub Total: {{App\Models\Order::where('id', $order_id)->first()->sub_total}}</td>
				</tr>
				<tr class="total">
					<td></td>
					<td></td>
					<td></td>
					<td>Delivery Charge: {{App\Models\Order::where('id', $order_id)->first()->delivery_charge}}</td>
				</tr>
				<tr class="total">
					<td></td>
					<td></td>
