                        ...
                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            ...
                            <form class="row g-3 p-2" action="{{route('customer.update')}}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control" id="inputEmail4" value="{{Auth::guard('customerlogin')->user()->email}}">
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>{{$order->total}}</td>
                                    <td>
                                        <a href="{{route('download.invoice', $order->id)}}" class="btn btn-primary">Download Invoice</a>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
