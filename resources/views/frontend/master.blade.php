...
<script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/63046f0a37898912e9649583/1gb4l3gvp';
    s1.charset='UTF-8';
    ...
    <div class="cart_sidebar">
        ...
        <ul class="cart_items_list ul_li_block mb_30 clearfix">
            ...
            <li>
                ...
                <a type="button" class="remove_btn" href="{{route('cart.remove', $cart->id)}}"><i class="fal fa-trash-alt"></i></a>
            </li>
            @php
...
================================================== -->
    ...
    <div class="body_wrap">
        ...
        ================================================== -->
        <header class="header_section {{ (Route::CurrentRouteName() == 'homepage'?'header-style-no-collapse':'header-style-3') }}">
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-12">
                                <div class="advance_serach">
                                    <div class="select_option mb-0 clearfix">
                                        <select class="selectstyle" id="category_list">
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                ...
                                <div class="allcategories_collapse {{ (Route::CurrentRouteName() == 'homepage'?'':'collapse') }}" id="allcategories_collapse">
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            @foreach (App\Models\Category::all() as $category)
                                            <li><a href="shop_grid.html"><i class="icon icon-Starship"></i> {{$category->category_name}}  - ({{App\Models\Product::where('category_id', $category->id)->count()}})</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
    ...
    <script>
        $('#search_btn').click(function (){
            ...
            var category_id = $('#category_list :selected').val();
