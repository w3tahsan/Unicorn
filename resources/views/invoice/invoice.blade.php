	...
	<div class="invoice-box">
			<table>
				<tr class="top">
					<td colspan="4">
						<table>
							<tr>
								<td class="title">
									<img src="https://i.postimg.cc/DfxtkxRg/download.png" alt="Company logo" style="width: 100%; max-width: 300px" />
								</td>
								<td>
									Invoice #: {{$order_id}}<br />
				...
				<tr class="total">
					<td></td>
					<td>
                        Delivery Charge: {{App\Models\Order::find($order_id)->delivery_charge}}</td>
				</tr>
				<tr class="total">
					<td></td>
