...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-md-4 m-auto order-md-1">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between">
                    <span>Total (BDT)</span>
                    <input type="hidden" name="total" value="{{$data['sub_total'] - $data['discount'] + ($data['charge'])}}">
                    <strong>{{$data['sub_total'] - $data['discount'] + ($data['charge'])}} TK</strong>
                </li>
            </ul>
