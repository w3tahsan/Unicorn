									...
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Todays Sales</p>
												<span class="title text-black font-w600">{{$todays_sales}} BDT</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-success" style="width: 42%; height:5px;" role="progressbar">
												<span class="sr-only">{{$todays_sales}}</span>
											</div>
										</div>
									</div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Last Day Sales</p>
												<span class="title text-black font-w600">{{$yesterday_sales}} BDT</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-secondary" style="width: 82%; height:5px;" role="progressbar">
												<span class="sr-only">{{$yesterday_sales}}</span>
											</div>
										</div>
									</div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Last Week</p>
												<span class="title text-black font-w600">{{$last_week}} BDT</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-danger" style="width: 90%; height:5px;" role="progressbar">
												<span class="sr-only">{{$last_week}}</span>
											</div>
										</div>
									</div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Last Month Sales</p>
												<span class="title text-black font-w600">{{$last_month}} BDT</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-warning" style="width: 42%; height:5px;" role="progressbar">
												<span class="sr-only">{{$last_month}}</span>
											</div>
										</div>
									</div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Total Product Sales Last Month</p>
												<span class="title text-black font-w600">{{$last_month_pro}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-warning" style="width: 42%; height:5px;" role="progressbar">
												<span class="sr-only">{{$last_month_pro}}</span>
											</div>
										</div>
									</div>
									<div class="effect bg-warning"></div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Total Product Quantity</p>
												<span class="title text-black font-w600">{{$last_month_pro_quan}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-warning" style="width: 42%; height:5px;" role="progressbar">
												<span class="sr-only">{{$last_month_pro_quan}}</span>
											</div>
										</div>
									</div>
									<div class="effect bg-warning"></div>
								...
								<div class="card avtivity-card">
									<div class="card-body">
										<div class="media align-items-center">
											...
											<div class="media-body">
												<p class="fs-14 mb-2">Total Order Last Month</p>
												<span class="title text-black font-w600">{{$last_month_order}}</span>
											</div>
										</div>
										<div class="progress" style="height:5px;">
											<div class="progress-bar bg-warning" style="width: 42%; height:5px;" role="progressbar">
												<span class="sr-only">{{$last_month_order}}</span>
											</div>
										</div>
									</div>
									<div class="effect bg-warning"></div>
...
<script>
    ...
    const myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Todays Sales', 'Yesterday Sales', 'Last Week', 'Last Month'],
            datasets: [{
                label: '# Amount',
                data: [{{$todays_sales}}, {{$yesterday_sales}}, {{$last_week}}, {{$last_month}}],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(54, 162, 235, 0.2)',
                    'rgba(255, 206, 86, 0.2)',
